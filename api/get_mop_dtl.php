...
if (!$conn) {
 ...
 $mop = $_GET['mop'];
						...
						SELECT
							...
							uw_docheader.PPS_DESC, uw_docheader.GDH_YEAR,
							...
							UW_AGTDTL.PPS_PARTY_CODE, UW_CITY.PCO_DESC
							FROM AILMIS.uw_docheader
							
							Join AILMIS.UW_GNDTL
							ON  uw_docheader.GDH_DOC_REFERENCE_NO = UW_GNDTL.GGD_DOC_REFERENCE_NO
							
							LEFT JOIN ailmis.UW_CITY
							ON ailmis.UW_CITY.PCO_CTRY_CODE = ailmis.uw_docheader.PAS_CITY
							
							JOIN AILMIS.UW_AGTDTL
												...
												$posts_arr = array();
                                                  while($res = oci_fetch_array($combo, OCI_ASSOC+OCI_RETURN_NULLS)) {
														 ...
														 $post_item = array(
																...
																'PPS_PARTY_CODE' => ($res['PPS_PARTY_CODE'] !== null ? htmlentities($res['PPS_PARTY_CODE'], ENT_QUOTES) : "&nbsp;"),
																'PCO_DESC' => ($res['PCO_DESC'] !== null ? htmlentities($res['PCO_DESC'], ENT_QUOTES) : "&nbsp;")
