...
<input type="password" name="fnew" name="fnew" placeholder="New Password" required
...
title="Must contain at least one number and one special character and one uppercase and lowercase letter, and at least 8 or more characters" name="fconf" id="fconf">
</div>
